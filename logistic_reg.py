...
print("values in data['SOCPDLIFE']")
soc = data['SOCPDLIFE'].value_counts(sort=False, dropna=True)
print(soc)
...
print (chk4)
crst = pandas.crosstab(sub1['S3AQ8B11'], sub1['S3AQ8B12'])

print ("crosstab",crst)

cg = sub1['S3AQ8B7J'].value_counts(sort=False, dropna=False)
print(cg)
